"use strict";(()=>{var e={};e.id=598,e.ids=[598],e.modules={20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},84770:e=>{e.exports=require("crypto")},6005:e=>{e.exports=require("node:crypto")},42100:(e,t,r)=>{r.r(t),r.d(t,{originalPathname:()=>h,patchFetch:()=>f,requestAsyncStorage:()=>p,routeModule:()=>u,serverHooks:()=>m,staticGenerationAsyncStorage:()=>d});var o={};r.r(o),r.d(o,{POST:()=>l});var n=r(49303),i=r(88716),a=r(60670),s=r(87070),c=r(69503);async function l(e){try{let{lectureContent:t}=await e.json();if(!t||"string"!=typeof t)return s.NextResponse.json({error:"Lecture content is required"},{status:400});let r=process.env.GEMINI_API_KEY;if(!r)return s.NextResponse.json({error:"Gemini API key not configured"},{status:500});let o=await (0,c.T)(t,r);return s.NextResponse.json({topics:o,success:!0})}catch(e){return console.error("Error in topics API:",e),s.NextResponse.json({error:"Failed to generate topic recommendations",details:e instanceof Error?e.message:"Unknown error"},{status:500})}}let u=new n.AppRouteRouteModule({definition:{kind:i.x.APP_ROUTE,page:"/api/qna/topics/route",pathname:"/api/qna/topics",filename:"route",bundlePath:"app/api/qna/topics/route"},resolvedPagePath:"C:\\Users\\Japne\\Desktop\\smarts\\temp-repo\\Web-Application\\app\\api\\qna\\topics\\route.ts",nextConfigOutput:"",userland:o}),{requestAsyncStorage:p,staticGenerationAsyncStorage:d,serverHooks:m}=u,h="/api/qna/topics/route";function f(){return(0,a.patchFetch)({serverHooks:m,staticGenerationAsyncStorage:d})}},69503:(e,t,r)=>{r.d(t,{T:()=>c,U:()=>l});var o=r(34248),n=r(20147),i=r(51592),a=r(20402);let s=(e,t)=>new n.XQ({name:"google_search",description:"Search Google for current information about academic topics and educational content. Use this to find relevant, up-to-date information about any topic.",schema:i.object({query:i.string().describe("The search query for academic or educational content")}),func:async({query:r})=>{try{let o=`https://www.googleapis.com/customsearch/v1?key=${e}&cx=${t}&q=${encodeURIComponent(r)}`,n=await fetch(o),i=await n.json();if(i.items&&i.items.length>0)return i.items.slice(0,5).map(e=>`Title: ${e.title}
Snippet: ${e.snippet}
